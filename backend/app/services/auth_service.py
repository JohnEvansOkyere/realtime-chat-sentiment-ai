...
class AuthenticationService:
    ...
    async def reset_password_simple(self, email: str, new_password: str) -> bool:
        """
        Simple password reset - update password if email exists
        ...
        try:
            ...
            # Hash new password - USE security_service
